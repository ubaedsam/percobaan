...
<div>
    ...
    <section class="mb-15 text-gray-800 text-center md:text-left">
    <h2 class="text-3xl font-bold mb-5 text-center">Customer satisfaction with our products is a pleasure for us</h2>
    <p class="text-gray-500 font-bold mb-2 text-center">Websiteku.id Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, velit?</p>
    <p class="text-gray-500 font-bold mb-10 text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo optio exercitationem ratione repudiandae quis nam laborum ipsum, consequuntur quas quasi.</p>
    ...
    <div class="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
        ...
        <div class="mb-6 md:mb-0">
        <h3 class="text-3xl text-center font-bold mb-3">Our <span class="text-orange-500">Vision</span></h3>
    ...
    <div class="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
        ...
        <h3 class="text-3xl text-center font-bold mb-3">Our <span class="text-orange-500">Mision</span></h3>
        <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            <li>
    ...
    <div class="grid md:grid-cols-2 m-10 gap-x-6 xl:gap-x-12 items-center mb-12">
        <div class="mb-6 md:mb-0">
          <div class="rounded-lg shadow-lg h-full block bg-white">
            <div class="flex justify-center">
              <div class="flex justify-center">
                <img src="/images/ubaed.jpg" class="rounded-full mx-auto shadow-lg" alt=""
                  style="width: 150px" />
              </div>
            </div>
            <div class="p-6 text-center">
              <h5 class="text-lg font-bold mb-2">Ubaed Shibghahtallah Ashri Muharam</h5>
              ...
              <ul class="list-inside flex mx-auto justify-center">
                <a href="#!" class="px-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-4 h-4 text-orange-500">
                    <path fill="currentColor"
                ...
                <a href="#!" class="px-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 text-orange-500">
                    <path fill="currentColor"
                ...
                <a href="#!" class="px-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-4 h-4 text-orange-500">
                    <path fill="currentColor"
        ...
        <div class="mb-6 md:mb-0">
        <h3 class="text-3xl text-center font-bold mb-3">My <span class="text-orange-500">Profile</span></h3>
        <p class="text-gray-500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quam similique quas accusamus cumque commodi eaque necessitatibus? Impedit cumque delectus assumenda dolores quod totam doloremque libero? Aperiam ipsa at ab delectus!</p>
        </div>
    </div>

    <h2 class="text-3xl font-bold mt-12 mb-12 text-center">Meet the <span class="text-orange-500">Our Team</span></h2>

    <div id="carouselExampleCaptions" class="carousel slide relative carousel-dark text-center" data-bs-ride="carousel">
